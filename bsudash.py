...
if page == "Dashboard":
    ...
    time_interval = st.selectbox("Select Time Interval", ["Weekly", "Daily", "Monthly", "Yearly"])
    ...
    st.markdown("<h2 style='text-align:center'>Brent Crude Oil Futures Conitinues Board</h2>", unsafe_allow_html=True)
    ...
    st.dataframe(combined_predictions.iloc[15:].style.set_properties(**{'background-color': '#e0e0e0'}), use_container_width=True)
    ...
    st.dataframe(combined_predictions_conv1d.iloc[15:].style.set_properties(**{'background-color': '#e0e0e0'}), use_container_width=True)
